...
DirectX::XMFLOAT4X4 Object::GetWorldMatrixScaledForOutlining(float p_scale)
{
	float offsetY = (3.194f * (p_scale - 1.0f)) * 0.5f;
	DirectX::XMFLOAT4X4 matrix;
	DirectX::XMStoreFloat4x4(&matrix, DirectX::XMMatrixTranslation(0.0f, -offsetY, 0.0f) *
