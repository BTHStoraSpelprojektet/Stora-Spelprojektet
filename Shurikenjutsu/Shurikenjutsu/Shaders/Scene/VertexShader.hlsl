...
Output main(Input p_input)
{
	...
	output.m_positionHomogenous.x += p_input.instancePosition.x;
	output.m_positionHomogenous.y += p_input.instancePosition.y;
	output.m_positionHomogenous.z += p_input.instancePosition.z;
