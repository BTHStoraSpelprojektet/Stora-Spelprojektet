...
void* FFAGameState::operator new(size_t i)
{
	return _mm_malloc(i, 16);
}
void FFAGameState::operator delete(void* p)
{
	_mm_free(p);
}

bool FFAGameState::Initialize()
{
	return Initialize(LEVEL_NAME);
}

void FFAGameState::EscapeIsPressed()
{
...
bool FFAGameState::Initialize(std::string p_levelName)
{
...
GAMESTATESWITCH FFAGameState::Update()
{
...
void FFAGameState::ToggleFullscreen(bool p_fullscreen)
{
	m_camera->ToggleFullscreen(p_fullscreen);
}

void FFAGameState::BasicPicking()
{
...
DirectX::XMFLOAT3 FFAGameState::Pick(Point p_point)
{
...
void FFAGameState::OutliningRays()
{
...
DirectX::XMFLOAT3 FFAGameState::NormalizeFloat3(DirectX::XMFLOAT3 p_f)
{
	float t2 = sqrt(p_f.x * p_f.x + p_f.y * p_f.y + p_f.z * p_f.z);
	return DirectX::XMFLOAT3(p_f.x / t2, p_f.y / t2, p_f.z / t2);
}

void FFAGameState::MinimapUpdatePos(Minimap *p_minimap)
{
...
ObjectManager* FFAGameState::GetObjectManager()
{
...
void FFAGameState::SetSound(Sound* p_sound)
{
	m_sound = p_sound;
}