...
bool Window::Initialize(WindowRectangle p_window)
{
	...
	// Create the window.
	m_handle = CreateWindow(description.lpszClassName, "Window Created.", WS_OVERLAPPEDWINDOW, p_window.x, p_window.y, p_window.width, p_window.height, 0, 0, GetModuleHandle(NULL), 0);
