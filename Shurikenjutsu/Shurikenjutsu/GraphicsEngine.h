...
public:
	...
	static void RenderParticles(ID3D11Buffer* p_mesh, ID3D11Buffer* p_indices, int p_indexCount, DirectX::XMFLOAT4X4 p_worldMatrix, ID3D11ShaderResourceView* p_texture);
