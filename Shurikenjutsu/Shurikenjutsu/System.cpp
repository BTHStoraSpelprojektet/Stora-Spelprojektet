...
bool System::Initialize(int p_argc, _TCHAR* p_argv[])
{
	...
	m_directionalLight.m_ambient = DirectX::XMVectorSet(1,1,1,1);//0.4f, 0.4f, 0.4f, 1.0f);
	m_directionalLight.m_diffuse = DirectX::XMVectorSet(0, 0, 0, 0);//1.125f, 1.125f, 1.125f, 1.0f);
	m_directionalLight.m_specular = DirectX::XMVectorSet(0, 0, 0, 0); //0.225f, 0.225f, 0.225f, 1.0f);
